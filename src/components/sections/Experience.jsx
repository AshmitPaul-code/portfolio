  ...
  return (
    <section id="experience" style={{ padding: "100px 0", position: "relative" }}>
      ...
      <div style={{ position: "relative", zIndex: 10, maxWidth: 1080, margin: "0 auto", padding: "0 32px" }}>
        <SectionHead index="02" title="Academic &" em="journey" />
        ...
        <div style={{ position: "relative", marginTop: 60, paddingBottom: 40 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 60, position: "relative" }}>
            ...
            {/* Milestone 1: BCA at DHSK College - CURRENT ROLE */}
            <div style={{ display: "grid", gridTemplateColumns: "140px 1fr", gap: 48, position: "relative" }} className="kk-milestone-row">
              ...
              <div style={{ position: "relative", zIndex: 2, display: "flex", flexDirection: "column", alignItems: "center", paddingTop: 20 }} className="kk-milestone-left">
                ...
                <div style={{ 
                  ...
                  <div style={{ ...serif, fontSize: 15, color: c.ink, fontWeight: 600 }}>2025 — 2028</div>
                </div>
              </div>
                ...
                <Reveal>
                  <div style={{
                    ...
                    <div style={{ color: c.clay, fontWeight: 600, marginTop: 4, fontSize: 14, ...mono }}>
                      DHSK College (Autonomous), Dibrugarh
                    </div>

                    <p style={{ color: c.inkSoft, fontSize: 14.5, lineHeight: 1.6, marginTop: 14, marginBottom: 18 }}>
                      Building a solid foundation in computer science, software design principles, algorithms, and practical programming.
                    </p>

                    <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 20 }}>
                      {[
                        "Maintained a 9.02 CGPA, ranking among the top academic performers in the class",
                        "Deepening core knowledge in C/C++, Java, Data Structures, and Database Management Systems",
                        "Engaging in practical laboratory exercises, algorithm challenges, and software fundamentals"
                      ].map((item, idx) => (
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
                      <ChipRow items={["C/C++", "Java", "Python", "Data Structures", "DBMS", "MySQL", "Problem Solving"]} bg="rgba(164,89,47,0.08)" fg={c.clay} />

                      {/* View Merit Recognition Button */}
                      <button
                      ...
                      >
                        <Award size={14} /> Merit Recognition
                      </button>
                    </div>
                  </div>
                </Reveal>
            ...
            {/* Milestone 2: Self-Directed Web Development */}
            <div style={{ display: "grid", gridTemplateColumns: "140px 1fr", gap: 48, position: "relative" }} className="kk-milestone-row">
              ...
              <div style={{ position: "relative", zIndex: 2, display: "flex", flexDirection: "column", alignItems: "center", paddingTop: 20 }} className="kk-milestone-left">
                ...
                <div style={{ 
                  ...
                  <div style={{ ...mono, fontSize: 11, color: c.clay, fontWeight: 700, letterSpacing: 1, textTransform: "uppercase", marginBottom: 2 }}>Projects</div>
                  <div style={{ ...serif, fontSize: 15, color: c.ink, fontWeight: 600 }}>2025 — Present</div>
                </div>
              </div>
              ...
              <div className="kk-milestone-card-container">
                <Reveal>
                  <div style={{
                    ...
                    <h3 style={{ ...serif, fontSize: 22, fontWeight: 600, marginTop: 14, color: c.ink }}>
                      Independent Web & Project Development
                    </h3>
                    <div style={{ color: c.clay, fontWeight: 600, marginTop: 4, fontSize: 14, ...mono }}>
                    ...
                    <p style={{ color: c.inkSoft, fontSize: 14.5, lineHeight: 1.6, marginTop: 14, marginBottom: 18 }}>
                      Designing, building, and deploying real-world web applications to translate theoretical computer science concepts into practical, working software.
                    </p>

                    <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 20 }}>
                      {[
                        "Built interactive browser applications including Rock Paper Scissors with dynamic DOM state tracking",
                        "Designed responsive websites with clean layouts and accessibility standards (Restaurant & Blood Donation portals)",
                        "Applied version control practices with Git and published live projects using GitHub Pages"
                      ].map((item, idx) => (
                        <div key={idx} style={{ display: "flex", gap: 8, fontSize: 13.5, color: c.inkSoft, lineHeight: 1.4 }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
                      <ChipRow items={["HTML5", "CSS3", "JavaScript", "DOM Manipulation", "Git", "GitHub Pages", "Responsive UI"]} bg="rgba(86,96,71,0.08)" fg={c.mossDeep} />
                    </div>
                  </div>
                </Reveal>
              </div>
      ...
      {/* Academic Excellence Certificate Modal */}
      <AnimatePresence>
        {showCertificate && (
          <motion.div
            initial={{ opacity: 0 }}
            ...
            >
              ...
              <div style={{
                ...
                <p style={{ color: c.inkSoft, fontSize: 14.5, lineHeight: 1.7, maxWidth: 540, margin: "0 auto 28px" }}>
                  In recognition of distinguished academic achievement and outstanding intellectual performance in the <strong style={{ color: c.ink }}>Bachelor of Computer Applications (BCA)</strong> program, maintaining a top-tier <strong style={{ color: c.ink }}>9.02 CGPA</strong>.
                </p>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, width: "100%", maxWidth: 480, marginTop: 12, borderTop: `1px solid ${c.line}`, paddingTop: 18 }}>
                  <div>
                    <div style={{ ...serif, fontStyle: "italic", fontSize: 16, color: c.ink, height: 26 }}>Department of CS</div>
                    <div style={{ ...mono, fontSize: 10, color: c.inkFaint, textTransform: "uppercase", letterSpacing: 1, marginTop: 4 }}>DHSK College</div>
                  </div>
                  <div>
                    <div style={{ ...serif, fontStyle: "italic", fontSize: 16, color: c.ink, height: 26 }}>Academic Council</div>
                    <div style={{ ...mono, fontSize: 10, color: c.inkFaint, textTransform: "uppercase", letterSpacing: 1, marginTop: 4 }}>Dibrugarh University</div>
                  </div>
                </div>
              </div>
            </motion.div>
